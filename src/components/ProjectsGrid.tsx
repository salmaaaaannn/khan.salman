...
function MetaversePreview() {
  ...
  return (
    <div className="relative w-full h-48 sm:h-56 rounded-2xl bg-[#07101A] border border-white/10 overflow-hidden select-none font-mono shadow-inner">
      {/* Grid Floor */}
      ...
      >
        <div className="relative w-6 h-6 rounded-full bg-cyan-400 border-2 border-white flex items-center justify-center text-[10px] font-bold text-slate-950 shadow-lg shadow-cyan-500/40">
          SK
...
function EventManagementPreview() {
  return (
    <div className="w-full h-48 sm:h-56 rounded-2xl bg-[#07101A] border border-white/10 p-4 font-mono text-xs text-slate-300 flex flex-col justify-between overflow-hidden shadow-inner">
      ...
      <div className="space-y-2.5 my-auto">
        <div className="p-2.5 rounded-lg bg-white/[0.03] border border-white/5 flex items-center justify-between">
          <div className="truncate">
            ...
            <span className="text-[10px] text-[#94A3B8]">Track: Cloud Systems • Hall A</span>
          </div>
        ...
        <div className="p-2.5 rounded-lg bg-white/[0.03] border border-white/5 flex items-center justify-between">
          <div className="truncate">
            ...
            <span className="text-[10px] text-[#94A3B8]">Track: AI Engineering • Room 3</span>
          </div>
          <span className="text-[10px] px-2 py-0.5 rounded bg-indigo-500/20 text-indigo-300 font-semibold shrink-0 ml-2">
            Matching
          </span>
        </div>
      </div>
      ...
      <div className="pt-2 border-t border-white/5 flex items-center justify-between text-[10px] text-[#94A3B8]">
        ...
        <span className="text-cyan-400">FastAPI & Python backend</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="w-full h-48 sm:h-56 rounded-2xl bg-[#07101A] border border-white/10 p-4 font-mono text-xs text-slate-300 flex flex-col justify-between overflow-hidden shadow-inner">
      <div className="flex items-center justify-between pb-2 border-b border-white/10 text-[11px]">
        ...
        <span className="text-[10px] text-cyan-300 font-semibold">Real-Time</span>
      </div>

      <div className="grid grid-cols-3 gap-2.5 my-auto text-center">
        <div className="p-2.5 rounded-lg bg-white/[0.03] border border-white/5">
          <span className="text-[10px] text-[#94A3B8] uppercase block">Reps Count</span>
          <span className="text-xl font-bold text-white">24</span>
          <span className="text-[9px] text-cyan-400 block">Form: 98%</span>
        </div>
        <div className="p-2.5 rounded-lg bg-white/[0.03] border border-white/5">
          <span className="text-[10px] text-[#94A3B8] uppercase block">Joint Angle</span>
          <span className="text-xl font-bold text-cyan-300">92°</span>
          <span className="text-[9px] text-cyan-400 block">Optimal</span>
        </div>
        <div className="p-2.5 rounded-lg bg-white/[0.03] border border-white/5">
          <span className="text-[10px] text-[#94A3B8] uppercase block">Cadence</span>
          <span className="text-xl font-bold text-slate-200">1.8s</span>
          <span className="text-[9px] text-[#94A3B8] block">Pace</span>
        </div>
      </div>

      <div className="pt-2 border-t border-white/5 flex items-center justify-between text-[10px] text-[#94A3B8]">
        <span>Pose Landmark Detection</span>
        <span className="text-cyan-400">Feedback Active</span>
      </div>
    </div>
  );
}
    ...
    <div className="w-full h-48 sm:h-56 rounded-2xl bg-[#07101A] border border-white/10 p-4 font-mono text-xs text-slate-300 flex flex-col justify-between overflow-hidden shadow-inner">
      ...
      <div className="space-y-2 my-auto text-[11px]">
        <div className="flex items-center space-x-2 text-slate-400">
          <span className="px-1.5 py-0.5 rounded bg-cyan-500/20 text-cyan-300 text-[9px] font-bold">GET</span>
          <span className="text-slate-200">/api/v1/items?filter=active</span>
          <span className="text-slate-500 text-[10px] ml-auto">200 OK</span>
        </div>
        <div className="flex items-center space-x-2 text-slate-400">
          <span className="px-1.5 py-0.5 rounded bg-indigo-500/20 text-indigo-300 text-[9px] font-bold">POST</span>
        ...
        <div className="flex items-center space-x-2 text-slate-400">
          ...
          <span className="text-cyan-400 text-[10px] ml-auto">Valid</span>
        </div>
      </div>
...
export function ProjectsGrid() {
  ...
  return (
    <section id="projects" className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        <div className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-xs font-mono text-cyan-300 mb-3">
        ...
        {otherProjects.map((proj, idx) => {
          return (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group rounded-3xl bg-[#0B1620]/80 border border-white/10 p-6 sm:p-8 backdrop-blur-xl transition-all duration-300 hover:border-cyan-500/35 hover:shadow-card-hover flex flex-col justify-between"
            >
              <div>
                ...
                <div className="space-y-2.5 mb-5 text-xs font-mono">
                  <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
                    <span className="text-[#94A3B8] font-semibold block text-[11px] mb-0.5">
                      Problem:
                    </span>
                    <span className="text-slate-300">{proj.problem}</span>
                  </div>
                  <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
                    <span className="text-cyan-400 font-semibold block text-[11px] mb-0.5">
                      Solution:
                    </span>
              ...
              <div className="pt-4 border-t border-white/5">
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {proj.technologies.map((t) => (
                    <span
                      key={t}
                      className="px-2.5 py-0.5 rounded text-[11px] font-mono bg-white/5 border border-white/10 text-slate-300 group-hover:border-cyan-500/25 transition-transform group-hover:translate-y-[-1px]"
                    >
                      {t}
                    </span>
                  ))}
