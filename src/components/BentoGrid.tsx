        ...
        {cards.map((card, idx) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className={`${card.colSpan} group relative rounded-2xl bg-[#0c1017]/90 border border-white/10 p-6 sm:p-7 backdrop-blur-md transition-all duration-300 hover:border-teal-500/40 hover:shadow-card-hover overflow-hidden`}
            >
              {/* Subtle Teal Gradient Wash on Hover */}
              ...
              <div className="flex items-start justify-between relative z-10 mb-4">
                ...
                <span className="text-[11px] font-mono px-2.5 py-0.5 rounded-full border bg-teal-500/10 text-teal-300 border-teal-500/30">
                  Verified
                </span>
              </div>
              ...
              <div className="relative z-10 my-2">
                <h3 className="text-lg sm:text-xl font-bold text-white tracking-tight group-hover:text-teal-200 transition-colors">
                  {card.value}
                </h3>
              </div>
              ...
              <div className="mt-5 pt-3 border-t border-white/5 flex items-center justify-between text-[11px] font-mono text-slate-500">
                ...
                <span className="text-teal-400 font-medium">0{idx + 1}</span>
              </div>
            </motion.div>
          );
        })}
